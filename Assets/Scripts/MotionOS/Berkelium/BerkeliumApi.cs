...
public class BerkeliumApi
{
	...
	public delegate void LoadingStateChangedFunc(bool isLoading);
	...
	public class Window
	{
		...
		[DllImport ("UnityBerkeliumPlugin", EntryPoint="Berkelium_Window_setLoadingStateChanged")]
		public static extern void setLoadingStateChanged(int windowID, LoadingStateChangedFunc callback);
